...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "company-rtags" '("rtags-comp" "company-rtags")))

;;;***

;;;### (autoloads nil "flycheck-rtags" "flycheck-rtags.el" (0 0 0
;;;;;;  0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "rtags" '("rdm-includes" "rtags-")))

;;;***

;;;### (autoloads nil "rtags-ac" "rtags-ac.el" (0 0 0 0))
;;; Generated autoloads from rtags-ac.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "rtags-ac" '("rtags-")))

;;;***

;;;### (autoloads nil "rtags-helm" "rtags-helm.el" (0 0 0 0))
;;; Generated autoloads from rtags-helm.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "rtags-helm" '("rtags-helm-")))
